<template>
    <div>
       ...
       <input type="number" v-model="numero_atual">
       <button @click="adicionando(parseFloat(numero_atual))" >+</button>
       <div class="lista">{{String(lista)}}</div>
...
<script>
import calc_mmc from './mmc'

export default {
    data() {
        return {
            lista: [],
            numero_atual: undefined,
            mmc: undefined
        }
    },
    methods: {
